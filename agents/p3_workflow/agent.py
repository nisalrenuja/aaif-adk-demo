...
activity_researcher = Agent(
    ...
    instruction=(
        "Trip preferences: {preferences?}\n"
        "\n"
        "Call research_activities once with the destination city and the "
        "traveller's interests. Reply with one line saying how many options you "
        "found and which interests they lean towards."
    ),
    tools=[research_activities],
...
itinerary_assembler = Agent(
    ...
    instruction=(
        ...
        "evening. Do not repeat an activity across days.\n"
        "\n"
